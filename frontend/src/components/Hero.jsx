...
// //   // ✅ CRITICAL: Use fallback immediately, update when data loads
// //   // This makes LCP instant instead of waiting for API
// //   const hero = useMemo(() => {
...
// //   // ✅ NO SKELETON - Render immediately with fallback data
// //   return (
// //     <section id="home" className="relative min-h-screen flex items-center justify-center px-4 md:px-6 overflow-hidden bg-black">
// //       <div className="absolute inset-0 overflow-hidden">
// //         {/* Base Gradient */}
...
// //       {/* HERO CONTENT - Renders immediately with fallback, updates when API loads */}
// //       <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="relative z-10 max-w-4xl w-full text-center px-2 md:px-4">
// //         <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, type: "spring", stiffness: 200 }} className="inline-block mb-4 md:mb-6">
// //           <span className="px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-cyan-500/20 border border-blue-500/50 rounded-full text-xs md:text-sm text-blue-400 font-medium backdrop-blur-sm shadow-lg shadow-blue-500/20">
// //             👋 Welcome to my portfolio
...
//             style={{ left: `${15 + i * 25}%`, top: `${30 + (i % 2) * 40}%`, color: i % 2 === 0 ? "#3b82f6" : "#9333ea" }}
...
//       {/* ✅ HERO CONTENT - INSTANT RENDER with ZERO delay */}
...
//         {/* H1 - INSTANT RENDER - No animation delay! */}
...
//         {/* H2 - Instant */}
//         <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300 mb-4 md:mb-6 font-light">
//           {hero.title}
//         </h2>

//         {/* Description - Instant */}
//         <p className="text-gray-400 text-sm md:text-lg mb-8 md:mb-10 leading-relaxed max-w-2xl mx-auto">
//           {hero.description}
//         </p>
...
//             whileTap={{ scale: 0.95 }} 
//             className="relative px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-full overflow-hidden shadow-lg shadow-blue-500/50 text-sm md:text-base"
//           >
//             <motion.span 
...
//             whileHover={{ scale: 1.05, y: -3 }} 
//             whileTap={{ scale: 0.95 }} 
//             className="px-6 md:px-8 py-3 md:py-4 border-2 border-gray-600 text-gray-300 font-semibold rounded-full hover:border-cyan-400 hover:text-cyan-400 hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 text-sm md:text-base"
//           >
//             View Projects
//           </motion.a>
...
//             whileHover={{ scale: 1.05, y: -3 }} 
//             whileTap={{ scale: 0.95 }} 
//             className="px-6 md:px-8 py-3 md:py-4 border-2 border-purple-500 text-purple-400 font-semibold rounded-full hover:bg-purple-500 hover:text-white hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 text-sm md:text-base"
//           >
//             📄 Resume
//           </motion.a>
//         </div>
